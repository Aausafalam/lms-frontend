...
const AlertDialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
    <div className={GlobalUtils.cn("flex flex-col space-y-2 text-center sm:text-left", className)} {...props} />
);
...
const AlertDialogDescription = React.forwardRef<React.ElementRef<typeof AlertDialogPrimitive.Description>, React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Description>>(
    ({ className, ...props }, ref) => <AlertDialogPrimitive.Description ref={ref} className={GlobalUtils.cn("text-sm text-muted-foreground", className)} {...props} />
);
