...
const LessonFormBase = ({ initialData = {}, lessonId = null }) => {
    const { isSaving, handleSave, formData, handlers, error, success } = useLessonFormData({ initialData });
        ...
        <div className="">
            <div className="">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-7 gap-6">
                    ...
                    {/* Main Content */}
                    <div className={GlobalUtils.cn("transition-all duration-300 ease-in-out", previewVisible ? "lg:col-span-4" : "lg:col-span-6", "col-span-1")}>
