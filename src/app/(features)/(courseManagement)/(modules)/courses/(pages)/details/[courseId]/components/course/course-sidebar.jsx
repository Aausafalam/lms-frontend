                ...
                <div className="p-5">
                    <div className="mb-1">
                        ...
                        <div className="flex gap-2">
                            <PremiumButton variant="primary" className="w-full mb-3  py-[0.6rem] text-sm">
                                Enroll Now
                            </PremiumButton>
                            <PremiumButton variant="outline" className="w-full flex mb-3 py-[0.6rem] text-sm">
                        ...
                        {/* <div className="flex items-center justify-center gap-2 mt-3">
                            ...
                            <p className="text-center text-sm text-gray-500 dark:text-gray-400">30-Day Money-Back Guarantee</p>
                        </div> */}
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <PremiumButton variant="outline" className="ml-auto text-sm">
                                <svg className="h-4 w-4 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
