                ...
                <div className="md:w-1/3">
                    <div className="bg-card p-8 rounded-2xl border shadow-sm text-center dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="text-center">
                            ...
                            <PremiumButton className="w-full bg-primary hover:bg-primary/90 rounded-full">Write a Review</PremiumButton>
                        </div>
                    </div>
                </div>
                ...
                <div className="md:w-2/3 space-y-6">
                    ...
                    {reviews.map((review, index) => (
                        <div key={index} className="border rounded-xl p-6 space-y-4 hover:shadow-md transition-all duration-300 dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div className="flex items-center justify-between">
                                <PremiumButton variant="ghost" size="sm" className="text-sm">
                                    <span className="mr-1 text-sm">Was this helpful?</span> ({review.helpful})
                                </PremiumButton>
                                <PremiumButton variant="ghost" size="sm" className="text-sm">
                                    Report
                                </PremiumButton>
                                    ...
                                    <div className="flex items-center mb-3">
                                        ...
                                        <div>
                                            <p className="text-base font-semibold">
                                                {review.reply.name}{" "}
                                                <PremiumBadge variant="outline" className="ml-1 text-xs">
                                                    Instructor
                                                </PremiumBadge>
                                            </p>
                    ...
                    <PremiumButton variant="outline" className="w-full rounded-full py-3">
                        Load More Reviews
                    </PremiumButton>
                </div>
            </div>
