                ...
                <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="md:w-2/3 text-center md:text-left">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <PremiumButton className="bg-primary hover:bg-primary/90 rounded-full py-2 px-6">Contact Support</PremiumButton>
                            <PremiumButton variant="outline" className="rounded-full py-2 px-6">
