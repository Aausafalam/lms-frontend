/**
 * Sample course data for development and testing
 * @description Static course data used for preview and development purposes
 */
export const courseDetailsData = {
  ...
  description: `
        ...
        By the end of this course, you'll have the skills to build complete web applications and the confidence to apply for web development positions.</p>
