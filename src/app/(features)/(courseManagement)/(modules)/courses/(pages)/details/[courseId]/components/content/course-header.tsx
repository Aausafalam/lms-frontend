...
export function CourseHeader({ course }: CourseHeaderProps) {
    ...
    return (
        <div
            className="w-full bg-cover bg-center relative rounded-xl"
            style={{
        ...
        >
            {/* Overlay gradient */}
            <div className="rounded-xl absolute inset-0 bg-gradient-to-br from-blue-900/90 via-purple-900/90 to-orange-900/90"></div>
                ...
                <div className="lg:flex items-start gap-8">
                    ...
                    <div className="lg:w-2/3 mb-8 lg:mb-0">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                            ...
                            <Badge variant="outline" className="bg-white/10 text-white backdrop-blur-sm border-white/20 shadow-lg hover:bg-white/20">
                                {course.level}
                            </Badge>
                        </div>

                        {/* Title and Subtitle */}
                        <h1 className={`font-bold text-white mb-3 tracking-tight ${isMobile ? "text-2xl" : isTablet ? "text-3xl" : "text-4xl"}`}>{course.title}</h1>
                        ...
                        <div className="flex items-center mb-6">
                            ...
                            <div>
                                <p className="text-white text-sm font-medium">Created by {course.instructors.map((i) => i.name).join(" & ")}</p>
                    ...
                    {!isMobile && !isTablet && (
                        <div className="lg:w-1/3 bg-white/10 backdrop-blur-md rounded-xl p-5 border border-white/20 shadow-xl">
                            ...
                            <p className="text-white/80 text-sm mb-4">
                                <span className="font-medium text-orange-300">Sale ends in</span> {Math.ceil((course.discountEnds.getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24))} days
                            </p>
