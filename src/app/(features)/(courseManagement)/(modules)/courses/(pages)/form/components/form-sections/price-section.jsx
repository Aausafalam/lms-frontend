...
export const PriceSection = memo(function PriceSection({ handlers = {}, formData = { price: {} }, sectionRef, isActive }) {
    ...
    return (
        ...
        >
            <div className="space-y-6">
                ...
                {isSalePriceHigher && (
                    <Alert variant="destructive" className="bg-red-50 text-red-800 border-red-200 dark:bg-red-950/20 dark:text-red-400 dark:border-red-900/30">
