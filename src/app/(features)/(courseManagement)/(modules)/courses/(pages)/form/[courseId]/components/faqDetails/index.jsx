        ...
        <div className={`dark:bg-gray-900 bg-gray-50`}>
            <div className="mx-auto px-4 py-8">
                {/* <div className="flex justify-between items-center mb-8">
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">FAQ Section Builder</h1>
                            ...
                            <div className="divide-y dark:divide-gray-700">
                                {faqItems.map((item, index) => (
                                    <div key={index} className="group">
                                        <button
                                            className="w-full text-left p-6 flex justify-between items-start hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors duration-200"
                                            onClick={() => {
                                                const updatedItems = [...faqItems];
                                                updatedItems[index].isOpen = !updatedItems[index].isOpen;
                                                setFaqItems(updatedItems);
