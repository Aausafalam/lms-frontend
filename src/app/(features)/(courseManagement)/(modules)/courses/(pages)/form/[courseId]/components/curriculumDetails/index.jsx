...
export default function CourseCurriculumDetails() {
    ...
    return (
        <div className={"dar:bg-gray-900 bg-gray-50"}>
            <div className="mx-auto px-4 py-8 ">
                {/* <div className="flex justify-between items-center mb-8">
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">Course Curriculum Builder</h1>
                    <div className="flex space-x-3">
                        <button
                            onClick={() => setShowPreview(!showPreview)}
                            className="px-4 py-2 rounded-md bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 shadow-sm border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors duration-200 flex items-center"
                        >
                            {showPreview ? <Edit3 size={16} className="mr-2" /> : <Eye size={16} className="mr-2" />}
                            {showPreview ? "Edit Mode" : "Preview"}
                        </button>
                        <button
                            onClick={toggleDarkMode}
                            className="p-2 rounded-full bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 shadow-sm border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors duration-200"
                        >
                            {darkMode ? "🌞" : "🌙"}
                        </button>
                    </div>
                            ...
                            <div key={moduleIndex} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                                ...
                                <div className="divide-y dark:divide-gray-700">
                                    {module.items.map((lesson, lessonIndex) => (
                                        <div key={lessonIndex} className="p-4 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-750">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6 border border-gray-100 dark:border-gray-700">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 text-center">
                                <div className="bg-orange-50 dark:bg-gray-750 p-3 rounded-lg">
                                    ...
                                    <div className="p-4 space-y-4">
                                        {module.items.length === 0 ? (
                                            ...
                                            module.items.map((lesson, lessonIndex) => (
                                                <div
                                                    key={lessonIndex}
                                                    className="bg-gray-50 dark:bg-gray-750 rounded-md border border-gray-200 dark:border-gray-700 hover:border-orange-200 dark:hover:border-orange-800 transition-colors duration-200 overflow-hidden"
                                                    draggable
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[80vh] flex flex-col">
                                ...
                                <div className="divide-y dark:divide-gray-700">
                                    {filteredContent.map((content) => (
                                        <button
                                            ...
                                            className="w-full text-left p-4 hover:bg-orange-50 dark:hover:bg-gray-750 flex items-center transition-colors duration-150"
                                        >
                        ...
                        <div className="p-4 border-t dark:border-gray-700 flex justify-between">
                            <button
                                ...
                                className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-750"
                            >
                                Cancel
                            </button>
