              ...
              <div className="flex items-center justify-between pt-2 border-t border-gray-100 dark:border-gray-800">
                ...
                <div className="text-right">
                  <div className="text-sm font-bold text-gray-900 dark:text-white">
                    {courseData.price?.current || "Free"}
                  </div>
                  {courseData.price?.original && (
    ...
    >
      <div className="relative w-full overflow-hidden rounded-lg bg-white shadow-md transition-all duration-300 hover:shadow-lg dark:bg-gray-900 dark:hover:bg-gray-800">
        ...
        <div className="relative h-32 sm:h-36 w-full overflow-hidden">
          ...
          <div className="absolute right-2 top-2">
            {courseData.tags?.slice(0, 1).map((badge, index) => (
              <span
                key={index}
                className="rounded-full bg-orange-500 px-2 py-0.5 text-xs font-medium text-white shadow-md capitalize"
              >
                {badge}
              </span>
            ))}
        ...
        <div className="relative p-3 sm:p-4">
          ...
          {/* Description */}
          <p className="mb-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400 line-clamp-2">
            {courseData.summary || "No description available"}
          </p>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-1">
              ...
              {courseData.price?.discount && (
                <span className="rounded bg-green-100 px-1 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900/30 dark:text-green-400">
                  {courseData.price.discount}
                </span>
              )}
            </div>
            <button className="group rounded-md bg-gradient-to-r from-orange-500 to-orange-600 px-2 sm:px-3 py-1 sm:py-1.5 text-xs font-medium text-white shadow-sm transition-all duration-300 hover:from-orange-600 hover:to-orange-700 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-1">
              <span className="flex items-center">
                Continue
                <ChevronRight className="ml-1 h-2.5 w-2.5 sm:h-3 sm:w-3 transition-transform group-hover:translate-x-0.5" />
              </span>
            </button>
          </div>
        </div>
