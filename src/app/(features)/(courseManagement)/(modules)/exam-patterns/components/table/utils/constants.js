...
/**
 * ExamPatterns table configuration constants
 * @description Centralized configuration for table behavior and API endpoints
 */
const examPatternsTableConstants = {
    API_URL: "exam-pattern",
...
export default examPatternsTableConstants;
