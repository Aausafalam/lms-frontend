const sampleExamPatternsTableData = {
    totalPages: 10,
    totalDocuments: 100,
    records: [
        {
        ...
        {
            id: "108",
            title: "Vue.js Crash ExamPattern",
            summary:
                "Build dynamic web apps using Vue.js, Vue Router, and Vuex in this fast-paced crash examPattern. Get hands-on experience creating single-page applications with reusable and reactive components.",
            instructors: [
                {
                    name: "Sophia Adams",
...
export default sampleExamPatternsTableData;
