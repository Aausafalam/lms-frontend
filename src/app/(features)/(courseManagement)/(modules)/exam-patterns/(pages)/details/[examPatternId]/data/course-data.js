/**
 * Sample examPattern data for development and testing
 * @description Static examPattern data used for preview and development purposes
 */
export const examPatternDetailsData = {
    id: "examPattern-123",
    ...
    description: `
        ...
        By the end of this examPattern, you'll have the skills to build complete web applications and the confidence to apply for web development positions.</p>
        <p>The examPattern includes practical projects, coding exercises, and real-world scenarios that prepare you for the modern web development landscape.</p>
    `,
    ...
    certificateCriteria: {
        ...
        certificateDescription:
            "Earn a professional certificate upon completion of the examPattern. This certificate verifies your proficiency in web development fundamentals and can be shared on your resume and professional profiles.",
