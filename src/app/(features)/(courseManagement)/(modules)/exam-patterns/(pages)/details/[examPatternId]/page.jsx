...
import ExamPatternDetailsHeader from "./components/header";
import { ErrorBoundary } from "@/components/ErrorBoundary";

/**
 * ExamPattern Details Page Component
 * @description Main page component for displaying examPattern details with tabbed navigation
 */
    ...
    if (!examPatternId) {
        return (
            <div className="flex items-center justify-center h-64">
                <p className="text-gray-500">ExamPattern ID is required</p>
            </div>
        );
    }
    ...
    return (
        <ErrorBoundary>
            <div className="transition-colors duration-300">
                <ExamPatternDetailsHeader examPatternId={examPatternId} />
