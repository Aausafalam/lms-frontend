...
const ExamPatternFormHeader = ({ children, togglePreview, previewVisible, examPatternId }) => {
    ...
    const breadcrumbItems = [
        ...
        {
            title: examPatternId ? `Edit Exam Pattern ${examPatternId}` : "Add ExamPattern",
            href: examPatternId ? `/exam-patterns/${examPatternId}` : "/exam-patterns/add",
