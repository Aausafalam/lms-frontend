...
/**
 * ExamPattern form utility constants and configurations
 * @description Centralized configuration for form options and data
 */
const ExamPatternFormUtils = {
    instructors: [
        ...
        { id: "3", name: "Dr. Emily Johnson", role: "ExamPattern Designer", avatar: "/placeholder.svg?height=40&width=40" },
...
export default ExamPatternFormUtils;
