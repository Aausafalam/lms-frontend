...
import { useExamPatternFormData } from "./hooks";
import { ExamPatternPreview } from "./components/preview";
...
const ExamPatternFormBase = ({ initialData = {}, examPatternId = null }) => {
    ...
    return (
        <ErrorBoundary>
            <div className="examPattern-form-container">
                ...
                <div className={`${layoutClasses.container} transition-all duration-300 ease-in-out`}>
                    ...
                    {!isMobile && !isTablet && previewVisible && (
                        <div className={`${layoutClasses.preview} transition-all duration-300`}>
                            <div className="sticky top-8">
                                <ExamPatternPreview data={formData} />
                            </div>
                        </div>
                    )}
                </div>
                ...
                {(isMobile || isTablet) && previewVisible && (
                    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm transition-all duration-300">
                        ...
                        >
                            <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
                                <h3 className="text-lg font-semibold">Exam Pattern Preview</h3>
