...
import LessonDetailsHeader from "./components/header";
import { ErrorBoundary } from "@/components/ErrorBoundary";

/**
 * Lesson Details Page Component
 * @description Main page component for displaying lesson details with tabbed navigation
 */
    ...
    if (!lessonId) {
        return (
            <div className="flex items-center justify-center h-64">
                <p className="text-gray-500">Lesson ID is required</p>
            </div>
        );
    }
    ...
    return (
        <ErrorBoundary>
            <div className="transition-colors duration-300">
                <LessonDetailsHeader lessonId={lessonId} />
