...
export const ResourcesSection = memo(function ResourcesSection({
  ...
  return (
    <FormSection
      ...
      description="Add helpful online resources and external links for your lesson"
      ...
      <div className="space-y-6">
        <div className="bg-purple-50 dark:bg-purple-950/10 rounded-lg p-4 border border-purple-100 dark:border-purple-900/20">
          <p className="text-sm text-purple-700 dark:text-purple-400 flex items-center gap-2">
            ...
            <span>
              Add links to documentation, tutorials, tools, or other helpful resources that complement your lesson.
            </span>
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          {resources.length === 0 && (
            <div className="text-center py-6 text-gray-500 dark:text-gray-400">
              ...
              <p className="text-sm">Add helpful links to enhance your lesson.</p>
            </div>
          )}
