...
export const SettingsSection = memo(function SettingsSection({ formData, handlers, sectionRef, isActive }) {
    return (
        <FormSection id="settings" title="Settings" icon={<Users className="h-5 w-5" />} description="Configure additional settings for your lesson" sectionRef={sectionRef} isActive={isActive}>
