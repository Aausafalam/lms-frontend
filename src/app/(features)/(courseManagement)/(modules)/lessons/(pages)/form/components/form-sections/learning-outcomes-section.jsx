 ...
 * Manages what students will learn from the lesson
 *
 ...
 */
export const LearningOutcomesSection = memo(function LearningOutcomesSection({ handlers = {}, formData = { learningOutcomes: [] }, sectionRef, isActive }) {
    ...
    return (
        <FormSection
            ...
            description="Define what students will achieve after completing this lesson"
            ...
            <div className="space-y-6">
                ...
                <div className="bg-blue-50 dark:bg-blue-950/10 rounded-lg p-4 border border-blue-100 dark:border-blue-900/20">
                    <p className="text-sm text-blue-700 dark:text-blue-400 flex items-center gap-2">
                        ...
                        <span>Write specific, measurable outcomes. Start with action verbs like "Create," "Analyze," "Implement," or "Design."</span>
                    </p>
                </div>
                ...
                <div className="space-y-4">
                    {outcomes.map((outcome, index) => (
                        <motion.div key={index} {...listItemAnimation} className="flex items-center gap-2" aria-label={`Learning outcome ${index + 1}`}>
                            {/* Outcome Number */}
