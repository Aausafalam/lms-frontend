...
const SortableLessonItem = memo(function SortableLessonItem({ lesson, index }) {
    ...
    return (
      ...
      `}
        ...
        ${isDragging ? "bg-orange-500 text-white shadow-lg" : "bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 group-hover:bg-orange-500 group-hover:text-white"}
      `}
            >
                {index + 1}
            </div>
...
export const LessonOrderSection = memo(function LessonOrderSection({
    formData,
    handlers,
    sectionRef,
    isActive,
    lessons = [
        { id: "1", name: "Introduction to React Fundamentals" },
        { id: "2", name: "State Management with Hooks" },
        { id: "3", name: "Component Lifecycle and Effects" },
        { id: "4", name: "Advanced Patterns and Performance" },
        { id: "5", name: "Testing React Applications" },
    ],
    onLessonsReorder,
}) {
    ...
    return (
        <FormSection id="lesson-order" title="Lesson Order" icon={<Settings className="h-5 w-5" />} description="Drag and drop to reorder lessons" sectionRef={sectionRef} isActive={isActive}>
            <div className="space-y-3">
                ...
                <div className="flex items-center justify-between px-3 py-2 bg-orange-50 dark:bg-orange-950/20 rounded-lg border border-orange-200 dark:border-orange-800 text-xs">
                    <div className="text-orange-700 dark:text-orange-300">
                        <span className="font-semibold">{items.length}</span> lessons
                    </div>
                ...
                {/* Action Hint */}
                <div className="text-xs text-gray-500 dark:text-gray-400 text-center pt-1 border-t border-gray-200 dark:border-gray-700">Changes auto-saved</div>
            </div>
        </FormSection>
    );
});
