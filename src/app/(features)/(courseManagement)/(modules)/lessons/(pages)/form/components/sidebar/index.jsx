...
import { FileText, ImageIcon, BookOpen, GraduationCap, Award, Settings, Paperclip, Users, User2Icon, Link2, Settings2, Settings2Icon } from "lucide-react";
...
export function SidebarNavigation({ activeSection, scrollToSection, formData, handlers }) {
    ...
    const navigationItems = [
        ...
        { id: "lesson-order", label: "Lesson Order", icon: <Settings className="h-4 w-4" /> },
