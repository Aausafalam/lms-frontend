...
export const InstructorsSection = memo(function InstructorsSection({ formData, handlers, sectionRef, isActive }) {
    ...
    return (
        <FormSection id="instructors" title="Lesson Instructors" icon={<User2Icon className="h-5 w-5" />} description="Configure lesson instructors" sectionRef={sectionRef} isActive={isActive}>
            <div className="space-y-6">
                ...
                <Select
                    ...
                    name="instructorIds"
                    placeholder="Select lesson instructors"
