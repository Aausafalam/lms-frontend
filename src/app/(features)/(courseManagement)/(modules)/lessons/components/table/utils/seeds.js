const sampleLessonsTableData = {
    ...
    records: [
        ...
        {
            id: "108",
            title: "Vue.js Crash Lesson",
            summary:
                "Build dynamic web apps using Vue.js, Vue Router, and Vuex in this fast-paced crash lesson. Get hands-on experience creating single-page applications with reusable and reactive components.",
            instructors: [
                {
                    name: "Sophia Adams",
...
export default sampleLessonsTableData;
