...
const LessonsTable = ({ onModuleDetailsPage = false, setSelectedLesson, setModalState, refreshTable, hideBreadcrumb }) => {
    ...
    const breadcrumbItems = [
        ...
        {
            title: "Lessons",
            href: `/lessons?courseId=${courseId}&moduleId=${moduleDetailsId}`,
            icon: <Package className="h-3.5 w-3.5" />,
        },
    ];
    ...
    const tableData = useMemo(() => formatTableData(sampleLessonsTableData), [refreshTable, onModuleDetailsPage, courseId, moduleDetailsId]);
