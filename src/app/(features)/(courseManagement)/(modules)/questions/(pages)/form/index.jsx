...
/**
 * Question Form Base Component
 * @description Main container for question creation/editing form with improved responsiveness
 */
const QuestionFormBase = ({ initialData = {}, questionId = null }) => {
    const { isSaving, handleSave, formData, handlers, validationErrors } = useQuestionFormData({ initialData });
    ...
    return (
        <ErrorBoundary>
            <div className="question-form-container">
                <QuestionFormHeader togglePreview={togglePreview} previewVisible={previewVisible} formData={formData} handlers={handlers} questionId={questionId} />
