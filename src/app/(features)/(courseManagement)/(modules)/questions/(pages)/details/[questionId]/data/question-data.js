/**
 * Sample question data for development and testing
 * @description Static question data used for preview and development purposes
 */
export const questionDetailsData = {
    ...
    description: `
        ...
        By the end of this question, you'll have the skills to build complete web applications and the confidence to apply for web development positions.</p>
        <p>The question includes practical projects, coding exercises, and real-world scenarios that prepare you for the modern web development landscape.</p>
    `,
    ...
    certificateCriteria: {
        ...
        certificateDescription:
            "Earn a professional certificate upon completion of the question. This certificate verifies your proficiency in web development fundamentals and can be shared on your resume and professional profiles.",
