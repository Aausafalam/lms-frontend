...
/**
 * Module Form Base Component
 * @description Main container for module creation/editing form with improved responsiveness
 */
const ModuleFormBase = ({ initialData = {}, moduleId = null }) => {
    const { isSaving, handleSave, formData, handlers, validationErrors } = useModuleFormData({ initialData });
