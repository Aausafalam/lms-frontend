...
export const BasicInfoSection = memo(function BasicInfoSection({ sectionRef, isActive, formData = {}, handlers = {} }) {
    ...
    const categories = [
        { label: "IT", value: "115d9494-9fbd-40ef-ba5d-c9004580a7d9" },
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Select
                        ...
                        value={formData?.categories?.map((item) => item.id) || formData.categoryIds || []}
                        onChange={handleInputChange}
                        options={categories}
                        isMulti
                ...
                <Input
                    ...
                    error={!formData.duration || formData.duration < 1 ? "Duration is required and must be at least 1 minute" : ""}
                />
