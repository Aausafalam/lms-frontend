            ...
            <div className="space-y-6">
                <div className="bg-orange-50 dark:bg-orange-950/10 rounded-lg p-4 border border-orange-100 dark:border-orange-900/20">
                    <p className="text-sm text-orange-700 dark:text-orange-400 flex items-center gap-2">
                        ...
                        <span>Write clear and specific prerequisites—focus on skills or concepts students should already know.</span>
                    </p>
                </div>

                <div className="space-y-4">
                    {prerequisites.map((item, index) => (
                        <motion.div key={index} {...listItemAnimation} className="flex items-center gap-2" aria-label={`Prerequisite ${index + 1}`}>
