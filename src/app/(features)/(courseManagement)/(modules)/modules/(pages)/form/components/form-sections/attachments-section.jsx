            ...
            <div className="space-y-6">
                ...
                <div className="bg-green-50 dark:bg-green-950/10 rounded-lg p-4 border border-green-100 dark:border-green-900/20">
                    <p className="text-sm text-green-700 dark:text-green-400 flex items-center gap-2">
                        ...
                        <span>Add PDFs, worksheets, code files, or other resources that complement your module content.</span>
                    </p>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    {attachments.length === 0 && (
                        <div className="text-center py-6 text-gray-500 dark:text-gray-400">
                            ...
                            <p className="text-sm">Add resources to enhance your module.</p>
                        </div>
                    )}
