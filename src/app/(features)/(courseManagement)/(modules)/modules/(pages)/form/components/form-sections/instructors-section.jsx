...
export const InstructorsSection = memo(function InstructorsSection({ formData, handlers, sectionRef, isActive }) {
    ...
    const instructors = [
        { id: "8e8abe4a-8464-44fe-a572-0037acadabda", name: "Prof. John Doe", role: "Lead Instructor" },
    ...
    return (
        <FormSection id="instructors" title="Module Instructors" icon={<Users className="h-5 w-5" />} description="Add instructors for this module" sectionRef={sectionRef} isActive={isActive}>
            <div className="space-y-6">
                <Select
                    ...
                    value={formData?.instructors?.map((item) => item.id) || formData.instructorIds || []}
