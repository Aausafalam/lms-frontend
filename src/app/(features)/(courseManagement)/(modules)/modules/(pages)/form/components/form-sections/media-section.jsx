...
export const MediaSection = memo(function MediaSection({ formData = {}, sectionRef, isActive, handlers = {} }) {
    ...
    const { courseId = "c0f6eba3-397c-47fe-81ff-e9f384df68d5" } = useParams();
    /**
        ...
        >
            <div className="space-y-6">
                ...
                <FileUploadField
                    ...
                    name="bannerImage"
                    helperText="Main module image displayed in module listings (recommended: 1200x600px)"
                    required
                    uploadPath={`/course/${courseId}/module/banner-image/upload`}
                    acceptedFormats={["png"]}
                />
