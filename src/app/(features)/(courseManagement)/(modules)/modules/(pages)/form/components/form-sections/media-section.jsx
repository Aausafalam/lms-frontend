                            ...
                            ? [
                                  {
                                      ...
                                      url: `${apiConstants.BACKEND_API_BASE_URL}/course/${courseId}/module/${formData.id}/getImage?type=thumbnailUrl&token=${ApiUtils.getAuthToken()}`,
                                  },
                              ]
                            : []
                    }
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        {(hasValidYoutubeUrl || hasUploadedVideo) && (
                            <Button variant="ghost" size="sm" onClick={clearVideo} className="text-red-500 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-950/20">
                    ...
                    <Tabs value={videoInputType} onValueChange={setVideoInputType} className="w-full">
                        ...
                        <TabsContent value="url" className="space-y-4">
                            <Input
                                ...
                                onChange={handleInputChange}
                                name="introVideo"
                                helperText="Paste a YouTube URL for your module preview video"
                            />
