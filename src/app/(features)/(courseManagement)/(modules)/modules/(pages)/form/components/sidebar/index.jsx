                        ...
                        {navigationItems.map((item) => (
                            <Button
                                ...
                                className={GlobalUtils.cn(
                                    ...
                                    activeSection === item.id ? "bg-orange-50 text-orange-700 dark:bg-orange-950/30 dark:text-orange-400" : ""
                                )}
                ...
                <CardContent className="p-4 pt-0">
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <SwitchComponent onCheckedChange={(data) => handleSwitchChange("isPublished", data)} id="isPublished" checked={formData.isPublished} />
                        </div>
                        <div className="flex items-center justify-between">
