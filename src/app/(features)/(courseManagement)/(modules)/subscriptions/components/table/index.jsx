...
const SubscriptionsTable = ({ setSelectedSubscription, setModalState, refreshTable, hideBreadcrumb }) => {
    ...
    const formatTableData = (data) => ({
        ...
        url: subscriptionsTableConstants.API_URL,
        ...
        tableHeader: SubscriptionsTableUtils.getTableHeader({
            ...
            setModalState,
            navigate,
            title: hideBreadcrumb ? "Subscription Plans" : <Breadcrumb items={breadcrumbItems} />,
            hideBreadcrumb,
        }),
        checkbox: true,
    ...
    const tableData = useMemo(() => formatTableData(sampleSubscriptionsTableData), [refreshTable]);
