...
import ExamDetailsContent from "./components/content";
import ExamDetailsHeader from "./components/header";
import { ErrorBoundary } from "@/components/ErrorBoundary";

/**
 * Exam Details Page Component
 * @description Main page component for displaying exam details with tabbed navigation
 */
    ...
    if (!examId) {
        return (
            <div className="flex items-center justify-center h-64">
                <p className="text-gray-500">Exam ID is required</p>
            </div>
        );
    }
    ...
    return (
        <ErrorBoundary>
            <div className="transition-colors duration-300">
                <ExamDetailsHeader examId={examId} />
                ...
                <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                        <ExamDetailsContent activeTab={activeTab} />
                    </div>
                </div>
