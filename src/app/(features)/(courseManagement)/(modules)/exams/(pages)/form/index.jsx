...
/**
 * Exam Form Base Component
 * @description Main container for exam creation/editing form with improved responsiveness
 */
const ExamFormBase = ({ initialData = {}, examId = null }) => {
    const { isSaving, handleSave, formData, handlers, validationErrors } = useExamFormData({ initialData });
