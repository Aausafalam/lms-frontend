const sampleExamsTableData = {
    ...
    records: [
        ...
        {
            id: "108",
            title: "Vue.js Crash Exam",
            summary:
                "Build dynamic web apps using Vue.js, Vue Router, and Vuex in this fast-paced crash exam. Get hands-on experience creating single-page applications with reusable and reactive components.",
            instructors: [
                {
                    name: "Sophia Adams",
...
export default sampleExamsTableData;
