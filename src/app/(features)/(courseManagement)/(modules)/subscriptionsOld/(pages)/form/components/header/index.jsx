...
import { Copy, Eye, EyeOff, CreditCard, School, Trash2 } from "lucide-react"
...
const SubscriptionFormHeader = ({ children, togglePreview, previewVisible, subscriptionId }) => {
  ...
  const breadcrumbItems = [
    ...
    {
      title: "Subscriptions",
      href: `/subscriptions?courseId=${courseId}`,
      icon: <CreditCard className="h-3.5 w-3.5" />,
    },
    {
      title: subscriptionId ? `Edit ${subscriptionId}` : "Add Plan",
      href: subscriptionId ? `/subscriptions/form/${subscriptionId}?courseId=${courseId}` : "/subscriptions/form/add",
      icon: <CreditCard className="h-3.5 w-3.5" />,
    },
  ]
