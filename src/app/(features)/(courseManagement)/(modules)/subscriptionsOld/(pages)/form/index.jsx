...
import SubscriptionFormHeader from "./components/header"
...
import { useSubscriptionFormData } from "./hooks"
import { SubscriptionPreview } from "./components/preview"
import { Alert, AlertDescription } from "@/components/ui/alert"

const SubscriptionFormBase = ({ initialData = {}, subscriptionId = null }) => {
  const { isSaving, handleSave, formData, handlers, error, success } = useSubscriptionFormData({ initialData })
      ...
      <div className="">
        ...
        {success && (
          <Alert className="mb-4 border-green-200 bg-green-50 text-green-800 dark:border-green-800 dark:bg-green-950 dark:text-green-200">
            ...
            <AlertDescription>Subscription plan saved successfully!</AlertDescription>
          </Alert>
        )}
          ...
          {previewVisible && (
            <div className="hidden lg:block lg:col-span-2">
              <div className="sticky top-6">
                <SubscriptionPreview data={formData} />
              </div>
            </div>
          )}
        </div>
...
export default SubscriptionFormBase
