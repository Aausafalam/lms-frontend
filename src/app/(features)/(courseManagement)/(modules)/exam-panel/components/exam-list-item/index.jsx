...
const ExamListItem = ({ exam, onStart, onResume }) => {
  ...
  return (
    <Card className="group hover:shadow-lg hover:shadow-orange-500/10 transition-all duration-300 border-gray-200 dark:border-gray-700 hover:border-orange-300 dark:hover:border-orange-600">
          ...
          <div className="flex-1 space-y-3">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
              <div className="space-y-2">
                ...
                <h3 className="font-semibold text-gray-900 dark:text-white text-lg group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">
                  {exam.name}
                </h3>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
              ...
              <div className="flex items-center text-gray-600 dark:text-gray-400">
                ...
                <span>{exam.startDate ? format(new Date(exam.startDate), "MMM dd, HH:mm") : "Date TBD"}</span>
              </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900 dark:text-white">
                      {exam.progress.answered}/{exam.totalQuestions} answered
                    </span>
                  </div>
              ...
              {exam.status === "completed" && exam.score !== undefined && (
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    >
                      {exam.score}% ({exam.score >= 60 ? "Passed" : "Failed"})
                    </span>
                  </div>
