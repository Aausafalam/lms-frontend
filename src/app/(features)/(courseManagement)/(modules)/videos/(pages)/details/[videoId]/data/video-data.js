/**
 * Sample video data for development and testing
 * @description Static video data used for preview and development purposes
 */
export const videoDetailsData = {
    id: "video-123",
    ...
    description: `
        ...
        By the end of this video, you'll have the skills to build complete web applications and the confidence to apply for web development positions.</p>
        <p>The video includes practical projects, coding exercises, and real-world scenarios that prepare you for the modern web development landscape.</p>
    `,
    ...
    certificateCriteria: {
        ...
        certificateDescription:
            "Earn a professional certificate upon completion of the video. This certificate verifies your proficiency in web development fundamentals and can be shared on your resume and professional profiles.",
