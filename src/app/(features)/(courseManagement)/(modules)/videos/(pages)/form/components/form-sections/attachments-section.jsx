 ...
 * Manages video attachments and resources
 *
 ...
 */
export const AttachmentsSection = memo(function AttachmentsSection({ handlers = {}, formData = { attachments: [] }, sectionRef, isActive }) {
    ...
    return (
        <FormSection
            ...
            description="Add supplementary materials and resources for your video"
            ...
            <div className="space-y-6">
                ...
                <div className="bg-green-50 dark:bg-green-950/10 rounded-lg p-4 border border-green-100 dark:border-green-900/20">
                    <p className="text-sm text-green-700 dark:text-green-400 flex items-center gap-2">
                        ...
                        <span>Add PDFs, worksheets, code files, or other resources that complement your video content.</span>
                    </p>
                </div>
                ...
                <div className="space-y-6">
                    {attachments.map((attachment, index) => (
                        <motion.div key={index} {...listItemAnimation} className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800/50">
                            ...
                            <div className="space-y-4">
                                {/* Title */}
                                <Input
                                    placeholder="Attachment title (e.g., Video Workbook, Code Examples)"
                                ...
                                <FileUploadField
                                    ...
                                    onChange={(e) => handleAttachmentChange(index, "file", e.target.value)}
                                    aria-label={`Attachment ${index + 1} file`}
                                    acceptedFormats={["pdf", "doc", "docx"]}
                                    accept=".,.doc,.docx,.zip,.txt,.js,.py,.html,.css"
                                />
                            </div>
                        </motion.div>
                    ))}
                    ...
                    {attachments.length === 0 && (
                        <div className="text-center py-6 text-gray-500 dark:text-gray-400">
                            ...
                            <p className="text-sm">Add resources to enhance your video.</p>
                        </div>
                    )}
