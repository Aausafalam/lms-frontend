...
import VideoFormHeader from "./components/header";
import { Button } from "@/components/ui/button";
import { SidebarNavigation } from "./components/sidebar";
import { ScrollArea } from "@/components/ui/scroll-area";
import { FormSections } from "./components/form-sections";
import { useVideoFormData } from "./hooks";
import { VideoPreview } from "./components/preview";
import { ErrorBoundary } from "@/components/ErrorBoundary";
import { hasValidationErrors } from "./utils/validation";

/**
 * Video Form Base Component
 * @description Main container for video creation/editing form with improved responsiveness
 */
const VideoFormBase = ({ initialData = {}, videoId = null }) => {
    const { isSaving, handleSave, formData, handlers, validationErrors } = useVideoFormData({ initialData });
    ...
    return (
        <ErrorBoundary>
            <div className="video-form-container">
                <VideoFormHeader togglePreview={togglePreview} previewVisible={previewVisible} formData={formData} handlers={handlers} videoId={videoId} />
