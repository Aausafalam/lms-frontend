        ...
        >
            ...
            <div className="relative h-36 w-full overflow-hidden">
                <Image
                    ...
                    height={1000}
                    src={
                        `${apiConstants.BACKEND_API_BASE_URL}/course/${courseId}/module/${moduleDetailsId}/lesson/${lessonData.id}/getImage?type=thumbnailUrl&token=${ApiUtils.getAuthToken()}` ||
            ...
            <div className="relative p-4 flex flex-col flex-grow">
                ...
                {/* Description */}
                <p className="min-h-14 text-xs leading-relaxed text-gray-600 dark:text-gray-300 line-clamp-3" name={lessonData.summary}>
                    {lessonData.summary}
                </p>
                ...
                <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <div className="flex items-center">
                        <div className="flex -space-x-2 mr-2">
                            {lessonData.instructors.slice(0, 3).map((instructors, index) => (
                                <Image
                                    key={index}
                                    width={24}
                                    height={24}
                                    ...
                                    className={GlobalUtils.cn("h-6 w-6 rounded-full ring-1 ring-white dark:ring-gray-800", lessonData.featured ? "ring-orange-500/50" : "")}
                                />
                            ))}
