...
export const SecurityProctoringSection = memo(function SecurityProctoringSection({
  handlers = {},
  formData = {},
  sectionRef,
  isActive,
      ...
      <div className="space-y-6">
        <div className="bg-red-50 dark:bg-red-950/10 rounded-lg p-4 border border-red-100 dark:border-red-900/20">
          <p className="text-sm text-red-700 dark:text-red-400 flex items-center gap-2">
            ...
            <span>
              Security settings help prevent cheating but may affect user experience. Test thoroughly before deployment.
            </span>
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 pl-6">
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={securitySettings.enableBrowserLockdown || false}
                onCheckedChange={(checked) => handleSecuritySettingsChange("enableBrowserLockdown", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={securitySettings.disableRightClick || false}
                onCheckedChange={(checked) => handleSecuritySettingsChange("disableRightClick", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={securitySettings.disableCopyPaste || false}
                onCheckedChange={(checked) => handleSecuritySettingsChange("disableCopyPaste", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={securitySettings.preventTabSwitching || false}
                onCheckedChange={(checked) => handleSecuritySettingsChange("preventTabSwitching", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={securitySettings.enableFullScreenMode || false}
                onCheckedChange={(checked) => handleSecuritySettingsChange("enableFullScreenMode", checked)}
              />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-4 pl-6">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Monitor students via webcam during exam</p>
              </div>
              <Switch
                checked={securitySettings.enableWebcamMonitoring || false}
                onCheckedChange={(checked) => handleSecuritySettingsChange("enableWebcamMonitoring", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Record student screens during exam</p>
              </div>
              <Switch
                checked={securitySettings.enableScreenRecording || false}
                onCheckedChange={(checked) => handleSecuritySettingsChange("enableScreenRecording", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={securitySettings.enableAIProctoring || false}
                onCheckedChange={(checked) => handleSecuritySettingsChange("enableAIProctoring", checked)}
              />
            </div>
          </div>
        </div>
        ...
        <Input
          ...
          onChange={(e) =>
            handleSecuritySettingsChange("suspiciousActivityThreshold", Number.parseInt(e.target.value, 10))
          }
