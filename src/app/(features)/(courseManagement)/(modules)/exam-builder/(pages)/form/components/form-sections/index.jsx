...
import { SubmissionRulesSection } from "./submission-rules-section"
import { UIConfigSection } from "./ui-config-section"
import { SecurityProctoringSection } from "./security-proctoring-section"
import { SchedulingAccessSection } from "./scheduling-access-section"
  ...
  return (
    <>
      ...
      <SectionsManager
        handlers={handlers}
        formData={formData}
        sectionRef={(el) => (sectionRefs.current.sections = el)}
      ...
      <GlobalSettingsSection
        handlers={handlers}
        formData={formData}
        sectionRef={(el) => (sectionRefs.current["global-settings"] = el)}
      ...
      <SchedulingAccessSection
        handlers={handlers}
        formData={formData}
        sectionRef={(el) => (sectionRefs.current["scheduling-access"] = el)}
        isActive={activeSection === "scheduling-access"}
      />

      <AttemptRulesSection
        handlers={handlers}
        formData={formData}
        sectionRef={(el) => (sectionRefs.current["attempt-rules"] = el)}
        isActive={activeSection === "attempt-rules"}
      />

      <SubmissionRulesSection
        handlers={handlers}
        formData={formData}
        sectionRef={(el) => (sectionRefs.current["submission-rules"] = el)}
        isActive={activeSection === "submission-rules"}
      />

      <ResultsAnalyticsSection
        handlers={handlers}
        formData={formData}
        sectionRef={(el) => (sectionRefs.current["results-analytics"] = el)}
        isActive={activeSection === "results-analytics"}
      />

      <AccessibilitySection
        handlers={handlers}
        formData={formData}
        sectionRef={(el) => (sectionRefs.current["accessibility"] = el)}
      ...
      <NotificationsSection
        handlers={handlers}
        formData={formData}
        sectionRef={(el) => (sectionRefs.current["notifications"] = el)}
      ...
      <UIConfigSection
        handlers={handlers}
        formData={formData}
        sectionRef={(el) => (sectionRefs.current["ui-config"] = el)}
        isActive={activeSection === "ui-config"}
      />
    </>
  )
})
