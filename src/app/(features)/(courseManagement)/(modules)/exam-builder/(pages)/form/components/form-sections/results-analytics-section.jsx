...
export const ResultsAnalyticsSection = memo(function ResultsAnalyticsSection({
  handlers = {},
  formData = {},
  sectionRef,
  isActive,
  ...
  const gradingScaleOptions = [
    ...
    { label: "Letter Grade (A-F)", value: "letter" },
    ...
    >
      <div className="space-y-6">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 pl-6">
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={resultsSettings.showResultsImmediately || false}
                onCheckedChange={(checked) => handleResultsSettingsChange("showResultsImmediately", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={resultsSettings.showCorrectAnswers || false}
                onCheckedChange={(checked) => handleResultsSettingsChange("showCorrectAnswers", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={resultsSettings.showDetailedAnalysis || false}
                onCheckedChange={(checked) => handleResultsSettingsChange("showDetailedAnalysis", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={resultsSettings.showSectionWiseResults || false}
                onCheckedChange={(checked) => handleResultsSettingsChange("showSectionWiseResults", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={resultsSettings.showRanking || false}
                onCheckedChange={(checked) => handleResultsSettingsChange("showRanking", checked)}
              />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <Select
            label="Result Display Format"
            labelIcon={<TrendingUp className="h-3.5 w-3.5" />}
            name="resultDisplayFormat"
            value={resultsSettings.resultDisplayFormat || "percentage"}
            onChange={(e) => handleResultsSettingsChange("resultDisplayFormat", e.target.value)}
            options={displayFormatOptions}
            helperText="How to display the final score"
          />
          ...
          <Select
            ...
            name="gradingScale"
            value={resultsSettings.gradingScale || "percentage"}
            onChange={(e) => handleResultsSettingsChange("gradingScale", e.target.value)}
            options={gradingScaleOptions}
            helperText="Grading system to use"
          />
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 pl-6">
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={resultsSettings.showPerformanceAnalytics || false}
                onCheckedChange={(checked) => handleResultsSettingsChange("showPerformanceAnalytics", checked)}
              />
            </div>

            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label className="text-base">Show Time Spent Analysis</Label>
                <p className="text-sm text-muted-foreground">Display time spent on each question/section</p>
              </div>
              <Switch
                checked={resultsSettings.showTimeSpentAnalysis || false}
                onCheckedChange={(checked) => handleResultsSettingsChange("showTimeSpentAnalysis", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={resultsSettings.enableResultsDownload || false}
                onCheckedChange={(checked) => handleResultsSettingsChange("enableResultsDownload", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={resultsSettings.enableCertificateGeneration || false}
                onCheckedChange={(checked) => handleResultsSettingsChange("enableCertificateGeneration", checked)}
              />
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                checked={resultsSettings.enableResultsEmail || false}
                onCheckedChange={(checked) => handleResultsSettingsChange("enableResultsEmail", checked)}
              />
            </div>

            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label className="text-base">Enable Comparison Analytics</Label>
                <p className="text-sm text-muted-foreground">Compare performance with class average</p>
              </div>
              <Switch
                checked={resultsSettings.enableComparisonAnalytics || false}
                onCheckedChange={(checked) => handleResultsSettingsChange("enableComparisonAnalytics", checked)}
              />
            </div>
          </div>
        </div>
