...
export const UIConfigSection = memo(function UIConfigSection({ handlers = {}, formData = {}, sectionRef, isActive }) {
    ...
    return (
        <FormSection id="ui-config" title="UI Configuration" icon={<Globe className="h-5 w-5" />} description="Configure the user interface for the exam" sectionRef={sectionRef} isActive={isActive}>
            <div className="space-y-6">
                ...
                <div className="space-y-4 pt-2">
                    <div className="flex items-center justify-between">
                        ...
                        <Switch checked={uiConfig.showTimer || false} onCheckedChange={(checked) => handleUIConfigChange("showTimer", checked)} />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Switch checked={uiConfig.languageSelector || false} onCheckedChange={(checked) => handleUIConfigChange("languageSelector", checked)} />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Switch checked={uiConfig.accessibleMode || false} onCheckedChange={(checked) => handleUIConfigChange("accessibleMode", checked)} />
                    </div>
                </div>
            </div>
        </FormSection>
