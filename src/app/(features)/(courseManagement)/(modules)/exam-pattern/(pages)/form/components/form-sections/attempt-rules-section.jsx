...
export const AttemptRulesSection = memo(function AttemptRulesSection({ handlers = {}, formData = {}, sectionRef, isActive }) {
    const { handleAttemptRuleChange } = handlers;
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4 pt-2">
                    <div className="flex items-center justify-between">
                        ...
                        <Switch checked={attemptRules.allowSectionNavigation || false} onCheckedChange={(checked) => handleAttemptRuleChange("allowSectionNavigation", checked)} />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Switch checked={attemptRules.allowQuestionNavigation || false} onCheckedChange={(checked) => handleAttemptRuleChange("allowQuestionNavigation", checked)} />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <Switch checked={attemptRules.allowBackNavigation || false} onCheckedChange={(checked) => handleAttemptRuleChange("allowBackNavigation", checked)} />
                    </div>
                </div>
            </div>
        </FormSection>
