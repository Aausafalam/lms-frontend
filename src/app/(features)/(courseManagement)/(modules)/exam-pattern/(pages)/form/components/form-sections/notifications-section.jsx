...
export const NotificationsSection = memo(function NotificationsSection({ handlers = {}, formData = {}, sectionRef, isActive }) {
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4 pl-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch checked={notificationSettings.enableSMSNotifications || false} onCheckedChange={(checked) => handleNotificationSettingsChange("enableSMSNotifications", checked)} />
                        </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4 pl-6">
                        <div className="flex items-center justify-between">
                            ...
                            <Switch checked={notificationSettings.sendExamReminders || false} onCheckedChange={(checked) => handleNotificationSettingsChange("sendExamReminders", checked)} />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch checked={notificationSettings.sendStartNotifications || false} onCheckedChange={(checked) => handleNotificationSettingsChange("sendStartNotifications", checked)} />
                        </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4 pl-6">
                        <div className="flex items-center justify-between">
                            ...
                            <Switch checked={notificationSettings.notifyInstructors || false} onCheckedChange={(checked) => handleNotificationSettingsChange("notifyInstructors", checked)} />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch checked={notificationSettings.notifyAdmins || false} onCheckedChange={(checked) => handleNotificationSettingsChange("notifyAdmins", checked)} />
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4 pl-6">
                        <div className="flex items-center justify-between">
                            ...
                            <Switch checked={notificationSettings.customEmailTemplate || false} onCheckedChange={(checked) => handleNotificationSettingsChange("customEmailTemplate", checked)} />
                        </div>
