...
export const SectionsManager = memo(function SectionsManager({
  ...
  const handleQuestionGroupDrop = (e, targetSectionIndex, targetGroupIndex) => {
    e.preventDefault()
    if (
      draggedQuestionGroup &&
      (draggedQuestionGroup.sectionIndex !== targetSectionIndex || draggedQuestionGroup.groupIndex !== targetGroupIndex)
    ) {
      const newSections = [...sections]
      ...
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 dark:bg-blue-950/10 rounded-lg p-4 border border-blue-100 dark:border-blue-900/20">
          <p className="text-sm text-blue-700 dark:text-blue-400 flex items-center gap-2">
            ...
            <span>
              Add multiple sections to your exam. Drag sections to reorder them. Each section can have its own settings
              and question groups.
            </span>
          </p>
        </div>
          ...
          {sections.map((section, sectionIndex) => (
            <motion.div
              ...
              className={`border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-white dark:bg-gray-800 ${
                draggedSection === sectionIndex ? "opacity-50" : ""
              }`}
              draggable
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-4 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    onClick={() => moveSectionUp && moveSectionUp(sectionIndex)}
                      ...
                      {section.questionGroups?.map((group, groupIndex) => (
                        <AccordionItem
                          ...
                          className={`border border-gray-200 dark:border-gray-700 rounded-md mb-3 overflow-hidden ${
                            draggedQuestionGroup?.sectionIndex === sectionIndex &&
                            draggedQuestionGroup?.groupIndex === groupIndex
                              ? "opacity-50"
                              : ""
                          }`}
                          draggable
                        ...
                        >
                          ...
                          <AccordionContent className="px-4 py-3 border-t border-gray-200 dark:border-gray-700">
                            <QuestionGroupForm
                              ...
                              onMoveDown={() =>
                                moveQuestionGroupDown && moveQuestionGroupDown(sectionIndex, groupIndex)
                              }
