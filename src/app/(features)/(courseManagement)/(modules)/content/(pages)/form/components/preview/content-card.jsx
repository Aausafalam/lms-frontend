 ...
 * Used for displaying various content sections with consistent styling
 */
export function ContentCard({ title, subTitle, icon, Icon, children, collapsible = false, defaultExpanded = true, headerColor = "blue", isMobile = false }) {
            ...
            <div className={`p-4 border-b ${colorClasses[headerColor]}`}>
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mt-0.5 ml-0.5 text-xs">{subTitle || ""}</p>
                    </div>
                    {collapsible && (
