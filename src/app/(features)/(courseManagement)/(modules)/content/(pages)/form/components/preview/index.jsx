...
import { ContentDetailPreview } from "./content-detail-preview"
...
export function ContentPreview({ data }) {
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="dark:bg-gray-900 border-2 border-t-0 border-white dark:border-gray-900 rounded-b-xl overflow-hidden shadow-sm w-full">
            <div className="overflow-hidden">
              <ContentDetailPreview data={data} viewportWidth={devicePresets.mobile} />
            </div>
          </div>
        </div>
      ),
      ...
      <Dialog open={showModal} onOpenChange={setShowModal}>
        ...
        >
          ...
          >
            ...
            >
              <ContentDetailPreview data={data} viewportWidth={devicePresets[activeTab.id]} />
            </div>
          </div>
        </DialogContent>
      </Dialog>
