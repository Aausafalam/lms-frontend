    ...
    >
      <div className="space-y-6">
        <Textarea
          ...
          id="description"
          name="description"
          placeholder="Write a comprehensive description of your content, what it covers, and how it benefits students"
          ...
          helperText="Detailed content information that helps students understand what they'll learn"
        />

        {isApproachingWordLimit && (
          <p className="text-sm text-yellow-600 dark:text-yellow-400">
            You are approaching the 1000 word limit. Current count: {currentWordCount} words.
          </p>
        )}
      </div>
    </FormSection>
