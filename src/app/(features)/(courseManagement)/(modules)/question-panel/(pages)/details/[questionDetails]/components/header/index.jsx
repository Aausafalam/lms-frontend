...
import { Copy, HelpCircle, List, Trash2, LayoutDashboard } from "lucide-react";
...
const QuestionFormHeader = ({ children, questionId }) => {
    ...
    const breadcrumbItems = [
        ...
        },
        {
            ...
            href: questionId ? `/question-panel/form/${questionId}` : "/question-panel/form/add",
                ...
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Button
                                onClick={() => navigate(`/question-panel/form/${questionId}`)}
                                variant="outline"
                                size="icon"
