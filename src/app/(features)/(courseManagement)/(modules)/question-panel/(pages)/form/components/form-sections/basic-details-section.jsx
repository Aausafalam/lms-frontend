            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <Select
                        ...
                        optionsUrl={{
                            url: `/course/${courseId}/exam/${examId}/section-list`,
                            valueKey: "name",
                        }}
                        placeholder="Select section"
                        required
                        helperText="exam pattern section"
                        error={!formData.category ? "Section is required" : ""}
                    />
                ...
                <div className="grid grid-cols-1 gap-6">
                    <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-slate-50 dark:from-gray-800 dark:to-slate-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                        <div>
                            ...
                            <p className="text-xs text-gray-600 dark:text-gray-400">Make this question available to other instructors</p>
                        </div>
                        <Switch checked={formData.isPublic || false} onCheckedChange={(checked) => handleSwitchChange("isPublic", checked)} />
                    </div>
                </div>
            </div>
        </FormSection>
