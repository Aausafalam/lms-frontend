...
export const QuestionContentSection = memo(function QuestionContentSection({
  sectionRef,
  isActive,
  formData = {},
  handlers = {},
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <Input
                ...
                onChange={(e) =>
                  handleInputChange({ target: { name: "answer", value: { value: Number.parseFloat(e.target.value) } } })
                }
    ...
    >
      <div className="space-y-6">
        ...
        <FileUploadField
          ...
          uploadPath={`/question/video/upload`}
