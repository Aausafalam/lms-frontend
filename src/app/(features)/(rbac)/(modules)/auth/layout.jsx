...
const AuthLayout = ({ children }) => {
    ...
    return (
        <div className="min-h-screen w-full overflow-hidden relative bg-slate-50">
            <main className="relative z-10 flex min-h-screen">
                {/* Left side - Branding and visuals (expanded) */}
                <div className="hidden lg:flex lg:w-7/12 xl:w-8/12 bg-gradient-to-br from-indigo-600 to-purple-700 relative overflow-hidden">
                    ...
                    <div className="relative w-full h-full flex flex-col justify-center px-12 lg:px-16 xl:px-24 2xl:px-32">
                        ...
                        <div className="absolute top-12 left-12 lg:left-16 xl:left-24 2xl:left-32">
                            <div className="bg-white/90 backdrop-blur-sm text-indigo-700 font-bold text-xl p-3 pl-4 pr-5 rounded-lg shadow-lg flex items-center">
                        ...
                        <div className="max-w-2xl">
                            ...
                            <p className="text-xl lg:text-xl text-indigo-100 mb-12 max-w-xl leading-relaxed">
                            ...
                            <div className="space-y-6 mt-8">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-indigo-100">Create engaging content with our intuitive course builder</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-indigo-100">Track progress and performance with detailed insights</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-indigo-100">Connect with your existing tools and workflows</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-16 bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 shadow-xl">
                                ...
                                <div className="flex items-center">
                                    <div className="w-10 h-10 bg-indigo-200 rounded-full flex items-center justify-center text-indigo-700 font-bold mr-3">JD</div>
                                    <div>
                                        <p className="text-white font-medium">Jane Doe</p>
                                        <p className="text-indigo-200 text-sm">Director of Learning, Acme Inc.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="relative w-full lg:w-5/12 xl:w-8/12  flex">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-indigo-50 via-white to-purple-50 z-0">
                        ...
                        <div className="absolute top-0 right-0 w-1/3 h-screen bg-gradient-to-b from-indigo-500/10 to-purple-500/5 blur-3xl transform -translate-y-1/4 translate-x-1/4 rounded-full"></div>
                        <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-gradient-to-tr from-purple-500/10 to-indigo-500/5 blur-3xl transform translate-y-1/4 -translate-x-1/4 rounded-full"></div>
                    ...
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                        <div className="floating absolute top-[15%] left-[10%] w-16 h-16 bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-xl rotate-12"></div>
                        <div className="floating absolute top-[25%] right-[15%] w-24 h-24 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-full"></div>
                        <div className="floating absolute bottom-[20%] left-[20%] w-20 h-20 bg-gradient-to-br from-blue-500/20 to-indigo-500/20 rounded-lg rotate-45"></div>
                    </div>
                    {/* Right side - form */}
                    {children}
                </div>
            ...
            {/* Footer - desktop only */}
            <footer className="hidden lg:block py-4 px-6 border-t border-gray-200 bg-white backdrop-blur-sm absolute bottom-0 w-full z-10">
                <div className="max-w-6xl mx-auto flex justify-between items-center text-sm text-gray-500">
                    ...
                    <div>
                        <button className="inline-flex items-center text-gray-500 hover:text-indigo-600 transition-colors duration-200">
