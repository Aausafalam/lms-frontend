...
import { Shield, Settings, Copy, Trash2 } from "lucide-react"
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/components/ui/tooltip"
import { Button } from "@/components/ui/button"

const PrivilegeGroupFormHeader = ({ privilegeGroupId }) => {
  const breadcrumbItems = [
    ...
    {
      title: privilegeGroupId ? `Edit Privilege Group` : "Add Privilege Group",
      href: privilegeGroupId ? `/rbac/privilege-groups/form/${privilegeGroupId}` : "/rbac/privilege-groups/form/add",
      icon: <Settings className="h-3.5 w-3.5" />,
    },
  ]
      ...
      <div className="flex items-center gap-3">
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>Duplicate Privilege Group</TooltipContent>
          </Tooltip>
        </TooltipProvider>
        ...
        {privilegeGroupId && (
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>Delete Privilege Group</TooltipContent>
            </Tooltip>
          </TooltipProvider>
        )}
      </div>
...
export default PrivilegeGroupFormHeader
