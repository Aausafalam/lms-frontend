...
export const RoutesSection = memo(function RoutesSection({ handlers = {}, formData = {}, sectionRef, isActive }) {
  ...
  const selectedRoutes = formData.routes || []
    ...
    >
      <div className="space-y-6">
        <Select
          ...
          value={formData.routes?.map((route) => route?.id) || []}
        ...
        <div className="bg-blue-50 dark:bg-blue-950/10 rounded-lg p-4 border border-blue-100 dark:border-blue-900/20">
          <p className="text-sm text-blue-700 dark:text-blue-400 flex items-center gap-2">
            ...
            <span>
              Routes define which API endpoints users with this privilege can access. Select all routes that should be
              available when this privilege is granted.
            </span>
          </p>
        </div>
      </div>
