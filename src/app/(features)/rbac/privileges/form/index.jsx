...
import PrivilegeFormHeader from "./components/header";
import { Button } from "@/components/ui/button";
import { Loader2, Save, CheckCircle, AlertCircle } from "lucide-react";
import { SidebarNavigation } from "./components/sidebar";
import { ScrollArea } from "@/components/ui/scroll-area";
import { FormSections } from "./components/form-sections";
import { usePrivilegeFormData } from "./hooks";
import { Alert, AlertDescription } from "@/components/ui/alert";

const PrivilegeFormBase = ({ initialData = {}, privilegeId = null }) => {
    const { isSaving, handleSave, formData, handlers, error, success } = usePrivilegeFormData({ initialData });
    ...
    return (
        <div className="max-w-[1400px]">
            <PrivilegeFormHeader privilegeId={privilegeId} />
            ...
            {success && (
                <Alert className="mb-4 border-green-200 bg-green-50 text-green-800 dark:border-green-800 dark:bg-green-950 dark:text-green-200">
                    ...
                    <AlertDescription>Privilege saved successfully!</AlertDescription>
                </Alert>
            )}
...
export default PrivilegeFormBase;
